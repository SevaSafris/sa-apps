...
class EmbeddedAMQPBroker {
  ...
  EmbeddedAMQPBroker() throws Exception {
    ...
    URL initialConfig = EmbeddedAMQPBroker.class.getClassLoader().getResource("qpid-config.json");

    brokerOptions.put("initialConfigurationLocation", initialConfig.toExternalForm());
